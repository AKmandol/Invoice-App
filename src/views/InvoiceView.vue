<template>
    ...
    <div class="invoice-details flex flex-column" id="docu">
        <div class="top flex">
        ...
        <div class="bottom flex flex-column">
            <div class="billing-items">
                ...
                <div v-for="(item, index) in currentInvoice.invoiceItemList" :key="index" class="item flex">
                    <p>{{ item.itemName }}</p>
                    <p>{{ item.qty }}</p>
                    <p>{{ item.price }} <small>tk</small></p>
                    <p>{{ item.total }} <small>tk</small></p>
                </div>
            </div>
            <div class="total flex">
                <p>Amount Due</p>
                <p>Tk. {{currentInvoice.invoiceTotal}}</p>
            </div>
        </div>
    </div>

       <button @click="generatePdf" class="dark-purple pdf-button">Save as PDF</button>
...
export default {
    ...
    methods: {
        ...
        generatePdf() {
          const pdfId = this.currentInvoice.invoiceId;
          window.html2canvas = html2canvas;
          var doc = new jsPDF("p", "pt", "A4");
          doc.html(document.querySelector("#docu"),{
...
.invoice-view {
  ...
  .pdf-button {
        ...
        &:hover {
          box-shadow: 1px 3px 1px 3px #0d0f1b;
        }
       }
